(function() {
  var Jackalope, TypeConstraints, Utils, extend,
    __slice = [].slice,
  ...
  Jackalope.Attributes = {
    createAccessor: function(proto, name, args) {
      ...
      if (args.handles) {
        Jackalope.Attributes.createHandles(proto, name, args);
      }
      if (args.clearer) {
        return Jackalope.Attributes.createClearer(proto, name, args);
      }
    },
    createClearer: function(proto, name, args) {
      return proto[args.clearer] = function() {
        return delete this.__values[name];
      };
    },
  ...
  Utils = {
    isa: function(typeName, value, name) {
      var args;
      args = {
        isa: typeName
      };
    ...
    are: function(typeName, values, name) {
      var i, value, _i, _len, _results;
      _results = [];
      for (i = _i = 0, _len = values.length; _i < _len; i = ++_i) {
        value = values[i];
        _results.push(this.isa(typeName, value, 'Value #' + i));
      }
      return _results;
    },
    isArray: function(value, name) {
      return this.isa('Array', value, name);
    },
    isBool: function(value, name) {
      return this.isa('Bool', value, name);
    },
    isFunction: function(value, name) {
      return this.isa('Function', value, name);
    },
    isInt: function(value, name) {
      return this.isa('Int', value, name);
    },
    isNum: function(value, name) {
      return this.isa('Number', value, name);
    },
    isNumber: function(value, name) {
      return this.isNum(value, name);
    },
    isObject: function(value, name) {
      return this.isa('Object', value, name);
    },
    isStr: function(value, name) {
      return this.isa('Str', value, name);
    },
    isString: function(value, name) {
      return this.isStr(value, name);
    }
  };
